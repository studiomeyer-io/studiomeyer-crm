...
StudioMeyer CRM works best with the rest of the suite. All products share the same account via Magic Link.

## MCP Server Products

| Product | Tools | Connect | Pricing |
|---------|-------|---------|---------|
| **[Memory](https://github.com/studiomeyer-io/studiomeyer-memory)** | 53 | `memory.studiomeyer.io/mcp` | Free / $29 / $49 |
| **[CRM](https://github.com/studiomeyer-io/studiomeyer-crm)** | 33 | `crm.studiomeyer.io/mcp` | Free / $29 / $49 |
...
CRM handles your contacts and pipeline. Memory remembers context across sessions. GEO monitors your AI visibility. Crew gives you expert personas for strategy. Connect all four for a complete AI workspace.
